...
fontStore.loadFonts(["GF;Playfair Display-500", "Inter-Black", "Inter-BlackItalic", "Inter-BoldItalic"]);
export const fonts = [{
    explicitInter: true,
    fonts: [{
