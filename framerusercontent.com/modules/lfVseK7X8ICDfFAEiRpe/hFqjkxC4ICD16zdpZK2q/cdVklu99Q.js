...
fontStore.loadFonts(["GF;Kumbh Sans-regular", "Inter-Bold", "Inter-BoldItalic", "Inter-Italic"]);
export const fonts = [{
    explicitInter: true,
    fonts: [{
        family: "Kumbh Sans",
