...
const variantClassNames = {
    UrAEL4TC_: "framer-v-17phonx",
    WrXhNFYOn: "framer-v-16pnsby"
};
...
const getProps = ({
    ...
    return { ...props,
        variant: humanReadableVariantMap[props.variant] ? ? props.variant ? ? "WrXhNFYOn"
    };
};
        ...
        children: /*#__PURE__*/ _jsx(Variants, {
            ...
            children: /*#__PURE__*/ _jsx(Transition, {
                ...
                children: /*#__PURE__*/ _jsx(motion.div, { ...restProps,
                    ...gestureHandlers,
                    className: cx(scopingClassNames, "framer-16pnsby", className, classNames),
 ...
 */
const FramerUXxoGouDT = withCSS(Component, css, "framer-Ya3yg");
export default FramerUXxoGouDT;
FramerUXxoGouDT.displayName = "Quotes";
FramerUXxoGouDT.defaultProps = {
    height: 24,
    width: 29
};
addPropertyControls(FramerUXxoGouDT, {
    variant: {
        options: ["WrXhNFYOn", "UrAEL4TC_"],
        optionTitles: ["Big", "Small"],
        title: "Variant",
        type: ControlType.Enum
    }
});
addFonts(FramerUXxoGouDT, [{
    explicitInter: true,
    fonts: []
}], {
...
//# sourceMappingURL=./UXxoGouDT.map